// Add image path and slug to each object
...
export const focusAreas = [
  ...
  },
  {
    ...
    image: "/immigration-law.png",
    description:
      "Immigration law regulates the entry, residence, employment, and exit ofpersons into and out of a country. It governs how foreign nationals are admitted, their legal status while in the country..."
  },
  {
    title: "Family law",
    slug: "family-law",
  ...
  },
  {
    ...
    image: "/adr.png",
    description:
      "Alternative Dispute Resolution (ADR) refers to methods of settling disputes outside the traditional court system. It includes processes such as mediation, negotiation, arbitration, and conciliation..."
  },
  {
    title: "Litigation ",
    slug: "litigation",
...
// *Note: You will need to create and save the respective images in your public or asset folder.*
